...
public:
    ...
    bool OnGossipSelect(Player* player, Creature* me, uint32 /*uiSender*/, uint32 uiAction)
    {
        ...
        case 8: // Script Info
            {
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Adaptado por: Clowned", GOSSIP_SENDER_MAIN, uiAction);
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Website: http://vps-plus.net", GOSSIP_SENDER_MAIN, uiAction);
