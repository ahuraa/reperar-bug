...
void World::LoadConfigSettings(bool reload)
{
	...
	m_bool_configs[COMMAND_BUFF_PREMIUM] = sConfigMgr->GetBoolDefault("Command.buff.Premium", false);
	m_bool_configs[COMMAND_REPAIR_PREMIUM] = sConfigMgr->GetBoolDefault("Command.repair.Premium", false);
